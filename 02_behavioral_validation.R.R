...
# SCRIPT: 02_behavioral_validation.R
# DESCRIPTION: 
#   Validates the behavioral pathway:
#   Step 1: Education -> Smoking (Pack-years)
#   Step 2: Smoking (Pack-years) -> Oral Cancer
#
# AUTHOR: Principal Investigator / EMBODY-LATAM Team
# DATE: January 2026
# ============================================================
rm(list = ls())
# --------------------------
...
out_M <- extract_outcome_data(snps = exp_X$SNP, outcomes = M_id,
...
out_Y <- extract_outcome_data(snps = exp_M$SNP, outcomes = Y_id,
                              proxies = TRUE, rsq = 0.8, align_alleles = 1,
                              palindromes = 1, maf_threshold = 0.3)
